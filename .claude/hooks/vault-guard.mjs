...
// "vault-obsidian/daily/../03-knowledge/x.md" -> "vault-obsidian/03-knowledge/x.md")
...
// vault-obsidian/daily/ directly. Same segment-boundary discipline as
// VAULT_SEGMENT_RE, so "daily-backup" or "dailyfoo" are never mistaken for it.
const DAILY_SEGMENT_RE = /(^|\/)vault-obsidian\/daily(\/|$)/;
...
const commandHit = command.includes("vault-obsidian/") && !isSafeGitPlumbing(rawCommand);
